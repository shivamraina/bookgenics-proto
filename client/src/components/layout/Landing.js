...
const homeInfo = props => (
  <React.Fragment>
    ...
    <div className="jumbotron">
      ...
      <h1 className="display-2"><strong>GENRE PREDICTION</strong></h1>		
      <hr className="my-4" />
      <p className='lead'><strong>The Marvellous coming together of MERN Stack, NLP and AI Algorithms.</strong></p>
    </div>
  </React.Fragment>
);
